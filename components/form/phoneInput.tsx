...
const baseClasses: { [key in keyof Classes]?: string } = {
  classes:
    'w-full h-10 rounded-krc-phone-input rounded-l-none px-3 py-2 outline-hidden placeholder:text-secondary-500 placeholder:text-sm text-secondary-900 text-sm disabled:pointer-events-none bg-white',
